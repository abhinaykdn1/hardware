...
//volatile long t = 0;
volatile unsigned int playingNotesFreq[SIMULTANEOUS_NOTES];
volatile unsigned int playingNotesPhase[SIMULTANEOUS_NOTES];
volatile char refreshNotesList = 1;
volatile int corTime = 0;
volatile int corTimeCnt = 0;
